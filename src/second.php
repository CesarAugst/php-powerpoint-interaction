...
->setPath(__DIR__ . './assets/images/pokephp_logo.png') //definindo o  logo no topo do slide
...
->setPath(__DIR__ . './assets/images/batata_frita.png') //definindo o  logo no topo do slide
...
$oWriterPPTX->save(__DIR__ . "./assets/presentation_files/exemplo2.pptx"); //definindo o nome de arquivo de saída
$oWriterODP = IOFactory::createWriter($objPHPPowerPoint, 'ODPresentation'); //definindo o tipo de arquivo como Open Document
$oWriterODP->save(__DIR__ . "./assets/presentation_files/exemplo2.odp"); //definindo o nome de arquivo de saída
