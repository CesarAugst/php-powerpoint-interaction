...
$oWriterPPTX->save(__DIR__ . "./assets/presentation_files/exemplo1.pptx"); //definindo o nome de arquivo de saída
$oWriterODP = IOFactory::createWriter($objPHPPowerPoint, 'ODPresentation'); //definindo o tipo de arquivo como Open Document
$oWriterODP->save(__DIR__ . "./assets/presentation_files/exemplo1.odp"); //definindo o nome de arquivo de saída